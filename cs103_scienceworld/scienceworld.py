...
class CS103ScienceWorldEnv:
    ...
    def __init__(self, taskName: str = None, serverPath: str = None, envStepLimit: int = 100):
        ...
        :param serverPath: The filepath to the server. By default, it is just cs103_scienceworld.jar.
    ...
    def get_object_types(self) -> Dict[str, int]:
        ...
        of the actual file, for example "cs103_scienceworld.objects.containers.furniture.Chair".
        '''
